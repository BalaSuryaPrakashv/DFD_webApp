...
def Result(videoPath):
    ...
    # Fixed: cross-platform model path (works on Windows and Linux)
    path_to_model = os.path.join(os.path.dirname(__file__), 'model', 'df_model.pt')
...
def upload_video():
    if request.method == 'POST':
        ...
        print(basepath)
        # Fixed: use os.path.join properly for cross-platform compatibility
...
if __name__ == '__main__':
    # Fixed: host and port for Hugging Face Spaces deployment
